...
namespace SOV.SGMO
{
    public class Track0 : IdName
    {
        ...
        /// <param name="lat0">Широта точки на исх. дату прогноза (градус)</param>
        /// <param name="lon0">Долгота точки на исх. дату прогноза (градус)</param>
        /// <param name="azimuth">Азимут перемещения объекта (градус куда).</param>
        /// <param name="speed">Скорость объекта (м/с).</param>
        /// <returns></returns>
        //static public double[/*индекс точки*/][/*lat,lon*/] _DELME_GetLatLon4Lags(DateTime dateIni, double[] lags, double lat0, double lon0, double speed, double azimuth)
        //{
        //    double[][] ret = new double[lags.Length][];
        //    Random rand = new Random();
        //    for (int i = 0; i < lags.Length; i++)
        //    {
        //        ret[i] = new double[] { 26 + rand.NextDouble(), 110 + rand.NextDouble() };
        //    }
        //    return ret;
        //}
        ...
        /// <returns></returns>
        //static public double[/*индекс точки*/][/*lat,lon*/] _DELME_GetLatLon4Lags(DateTime dateIni, double[] lags,
        ...
        //    for (int i = 0; i < lags.Length; i++)
        //    {
        //        ret[i] = new double[] { 55 + rand.NextDouble(), 172.5 + rand.NextDouble() };
        //    }
        //    return ret;
        //}
        ...
        public List<PointLag> GetPointLags(DateTime dateIni, double[] lags)
        {
            ...
            double[,] ll = Track0.GetLatLon4Lags(dateIni, lags,
