...
namespace FERHRI.Sakura.Meta
{
    ...
    /// </summary>
    [DataContract]
    public class _DELME_GeoRectangle
    {
        [DataMember]
        ...
        /// </summary>
        [DataMember]
        public _DELME_GeoPoint NorthWest;
        /// <summary>
        /// Юго-восточный угол региона.
        /// </summary>
        [DataMember]
        public _DELME_GeoPoint SouthEast;
        /// <summary>
        ...
        /// </summary>
        public _DELME_GeoRectangle(_DELME_GeoPoint centralPoint, double latGrdFromCenterPoint, double lonGrdFromCenterPoint, string name)
        {
            init(
        ...
        /// Инициализация экземпляра класса.
        /// </summary>
        public _DELME_GeoRectangle(_DELME_GeoPoint north_west, _DELME_GeoPoint south_east, string name)
        {
        ...
        /// Инициализация экземпляра класса.
        /// </summary>
        public _DELME_GeoRectangle(double south, double north, double west, double east, string name, int id = -1)
        {
        ...
        /// Инициализация экземпляра класса.
        /// </summary>
        public _DELME_GeoRectangle(_DELME_GeoRectangle gr)
        {
        ...
        private _DELME_GeoRectangle(string s)
        {
        ...
        /// </summary>
        public bool IsPointBelong(_DELME_GeoPoint geoPoint)
        {
        ...
        private void init(double s, double n, double w, double e, string name)
        {
            ...
            NorthWest = new _DELME_GeoPoint(n, w);
            SouthEast = new _DELME_GeoPoint(s, e);
            this.Name = name;
        }
        /// <summary>
        ...
        static public string ToString(_DELME_GeoRectangle[] gr)
        {
            string ret = "";
        ...
        /// <returns></returns>
        static public _DELME_GeoRectangle[] ParseGeoRegions(string geoRegs)
        {
            string[] s = geoRegs.Split(GEOREGS_SPLITTER);
            _DELME_GeoRectangle[] ret = new _DELME_GeoRectangle[s.Length];
            for (int i = 0; i < ret.Length; i++)
            {
                ret[i] = new _DELME_GeoRectangle(s[i]);
            }
            return ret;
        }
        static public _DELME_GeoRectangle Parse(string sgeoReg)
        {
            return new _DELME_GeoRectangle(sgeoReg);
        }
        /// <summary>
        /// Возвращает строку, представляющую текущий экземпляр класса. Разделитель / Строку можно использовать для создания нового экземпляра класса.
        /// </summary>
        ...
        public static bool operator <=(_DELME_GeoRectangle g1, _DELME_GeoRectangle g2)
        {
        ...
        public static bool operator ==(_DELME_GeoRectangle g1, _DELME_GeoRectangle g2)
        {
            try
            {
                if (g1.NorthWest.LatGrd == g2.NorthWest.LatGrd && g1.NorthWest.LonGrd == g2.NorthWest.LonGrd
                    && g1.SouthEast.LatGrd == g2.SouthEast.LatGrd && g1.SouthEast.LonGrd == g2.SouthEast.LonGrd) return true;
            }
            catch
            {
        ...
        public double getLonBeltMin()
        {
            ...
            return _DELME_GeoPoint.Grd2Min(SouthEast.LonGrd - NorthWest.LonGrd);
        }

        public double getLatBeltMin()
        {
            return _DELME_GeoPoint.Grd2Min(NorthWest.LatGrd - SouthEast.LatGrd);
        }
    }
}
