...
namespace FERHRI.Sakura.Meta
{
    ...
    public partial class Grid
    {
        ...
        public GeoRectangle GeoRectangle
        {
            get
            {
                return new GeoRectangle(GeoPoint.Min2Grd(SouthMin), GeoPoint.Min2Grd(NorthMin), GeoPoint.Min2Grd(WestMin), GeoPoint.Min2Grd(EastMin), "Obtained from Grid");
            }
        }
        ...
        public List<GeoPoint> GetGeoPoints()
        {
            ...
            for (int i = 0; i < LatsMin.Length; i++)
            {
                ...
                {
                    ret.Add(new GeoPoint(LatsMin[i] / 60, LonsMin[j] / 60));
                }
            }
            return ret;
        }
        ...
        public int[/*iLat, iLon*/] GetNearestPoint(double latMin, double lonMin, GeoPoint.NearestType nearestType)
        {
            int[] ret = null;
            ...
            if (nodesIdx != null)
            {
                ...
                for (int i = 1; i < nodesIdx.Count; i++)
                {
                    ...
                    switch (nearestType)
                    {
                        case GeoPoint.NearestType.Nearest2East:
        ...
        public double CurLonGrd
        {
            get
            {
                return GeoPoint.Min2Grd(CurLonMin);
            }
        }
        /// <summary>
