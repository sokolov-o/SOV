...
namespace FERHRI.Sakura.Grib
{
    public class _DELME_Grib2
    {
        ...
        public _DELME_Grid hmdicGrid;
        public string dataCnn;
        public int GDSGdtn = -1;

        public _DELME_Grib2(int IsDiscipline, int IDCenter_id,
            ...
            float PDSValueFirstFixedSurface, float PDSValueSecondFixedSurface, _DELME_Grid hmdicGrid,
            string dataCnn)
        {
    ...
    string dataCnn)
        ...
        public bool equals(Grib2Record rec, _DELME_Grid grid)
        {
